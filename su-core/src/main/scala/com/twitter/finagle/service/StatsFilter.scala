...
object StatsFilter {
  ...
  def module[Req, Rep]: Stackable[ServiceFactory[Req, Rep]] =
    new Stack.Module4[param.Stats, param.ExceptionStatsHandler, param.ResponseClassifier, Param, ServiceFactory[Req, Rep]] {
  ...
  def typeAgnostic(
    ...
    exceptionStatsHandler: ExceptionStatsHandler): TypeAgnostic = typeAgnostic(
  ...
  def typeAgnostic(
    ...
    timeUnit: TimeUnit): TypeAgnostic = new TypeAgnostic {
...
class StatsFilter[Req, Rep](
  ...
  def this(
    statsReceiver: StatsReceiver,
    exceptionStatsHandler: ExceptionStatsHandler,
    timeUnit: TimeUnit) = this(statsReceiver, ResponseClassifier.Default, exceptionStatsHandler, timeUnit)
