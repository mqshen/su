 ...
 *
 * - [[com.twitter.finagle.netty.ssl.SslConnectHandler]]
 * - [[com.twitter.finagle.netty.proxy.HttpProxyConnectHandler]]
 * - [[com.twitter.finagle.netty.proxy.NettyProxyConnectHandler]]
 */
private[netty] trait ConnectPromiseDelayListeners {
