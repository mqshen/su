...
import com.twitter.finagle.netty.proxy.{HttpProxyConnectHandler, NettyProxyConnectHandler}
import com.twitter.finagle.netty.ssl.client.NettyClientSslHandler
...
/**
  ...
  */
private[netty] abstract class AbstractNettyClientChannelInitializer(params: Stack.Params)
  extends ChannelInitializer[Channel] {
  import NettyClientChannelInitializer._
  ...
  def initChannel(ch: Channel): Unit = {
    ...
    pipe.addFirst("sslInit", new NettyClientSslHandler(params))
    ...
    socksAddress.foreach { sa =>
      ...
      pipe.addFirst("socksProxyConnect",
        new NettyProxyConnectHandler(proxyHandler, bypassLocalhostConnections = true))
    }
    ...
    httpAddress.foreach { sa =>
      ...
      pipe.addFirst("httpProxyConnect", new NettyProxyConnectHandler(proxyHandler))
    }
