...
private[netty] trait ChannelSnooper extends ChannelDuplexHandler {
  def name: String
...
/** Log message events */
@Sharable
private[netty] class ByteBufSnooper(val name: String) extends ChannelSnooper {
...
private[netty] class SimpleChannelSnooper(val name: String) extends ChannelSnooper {
...
private[netty] object ChannelSnooper {
  /**
