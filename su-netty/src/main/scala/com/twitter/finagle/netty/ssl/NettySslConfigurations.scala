...
object NettySslConfigurations {
  ...
  def configureTrust(
    ...
    trustCredentials: TrustCredentials): SslContextBuilder = {
  ...
  def configureApplicationProtocols(
    builder: SslContextBuilder,
    applicationProtocols: ApplicationProtocols): SslContextBuilder = {
  ...
  def configureProvider(
    builder: SslContextBuilder,
    forceJdk: Boolean): SslContextBuilder =
