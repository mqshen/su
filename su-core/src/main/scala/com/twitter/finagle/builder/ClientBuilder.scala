...
object ClientBuilder {
  type Complete[Req, Rep] = ClientBuilder[Req, Rep, ClientConfig.Yes, ClientConfig.Yes, ClientConfig.Yes]
  type NoCluster[Req, Rep] = ClientBuilder[Req, Rep, Nothing, ClientConfig.Yes, ClientConfig.Yes]
  type NoCodec = ClientBuilder[_, _, ClientConfig.Yes, Nothing, ClientConfig.Yes]
...
class ClientBuilder[Req, Rep, HasCluster, HasCodec, HasHostConnectionLimit] private[finagle] (
  ...
  private def copy[Req1, Rep1, HasCluster1, HasCodec1, HasHostConnectionLimit1](
    client: StackBasedClient[Req1, Rep1]): ClientBuilder[Req1, Rep1, HasCluster1, HasCodec1, HasHostConnectionLimit1] =
    new ClientBuilder(client)

  private def _configured[P, HasCluster1, HasCodec1, HasHostConnectionLimit1](
    param: P)(
      implicit stackParam: Stack.Param[P]): ClientBuilder[Req, Rep, HasCluster1, HasCodec1, HasHostConnectionLimit1] =
   ...
   */
  def hosts(
    hostnamePortCombinations: String): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] = {
   ...
   */
  def hosts(
    sockaddrs: Seq[InetSocketAddress]): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
   ...
   */
  def hosts(
    address: InetSocketAddress): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
    hosts(Seq(address))
  ...
  @varargs
  def addrs(
    addrs: Address*): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
   ...
   */
  def dest(
    addr: String): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] = {
   ...
   */
  def dest(
    name: Name): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
  ...
  def cluster(
    cluster: Cluster[SocketAddress]): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
    group(Group.fromCluster(cluster))

  @deprecated("Use ClientBuilder.dest with a com.twitter.finagle.Name", "2017-04-18")
  def group(
    group: Group[SocketAddress]): ClientBuilder[Req, Rep, Yes, HasCodec, HasHostConnectionLimit] =
   ...
   */
  def codec[Req1, Rep1](
    codec: Codec[Req1, Rep1]): ClientBuilder[Req1, Rep1, HasCluster, Yes, HasHostConnectionLimit] =
   ...
   */
  def codec[Req1, Rep1](
    codecFactory: CodecFactory[Req1, Rep1]): ClientBuilder[Req1, Rep1, HasCluster, Yes, HasHostConnectionLimit] =
   ...
   */
  def codec[Req1, Rep1](
    codecFactory: CodecFactory[Req1, Rep1]#Client): ClientBuilder[Req1, Rep1, HasCluster, Yes, HasHostConnectionLimit] = {
   ...
   */
  def stack[Req1, Rep1](
    client: StackBasedClient[Req1, Rep1]): ClientBuilder[Req1, Rep1, HasCluster, Yes, Yes] = {
   ...
   */
  def buildFactory()(
    implicit THE_BUILDER_IS_NOT_FULLY_SPECIFIED_SEE_ClientBuilder_DOCUMENTATION: ClientConfigEvidence[HasCluster, HasCodec, HasHostConnectionLimit]): ServiceFactory[Req, Rep] = {
    val Label(label) = params[Label]
   ...
   */
  def build()(
    implicit THE_BUILDER_IS_NOT_FULLY_SPECIFIED_SEE_ClientBuilder_DOCUMENTATION: ClientConfigEvidence[HasCluster, HasCodec, HasHostConnectionLimit]): Service[Req, Rep] = {
    val Label(label) = params[Label]
    val DestName(dest) = params[DestName]
...
private case class CodecClient[Req, Rep](
  ...
  def newClient(dest: Name, label: String): ServiceFactory[Req, Rep] = {
    ...
    case class Client(
        ...
        params: Stack.Params = params) extends StdStackClient[Req, Rep, Client] {
      protected def copy1(
    ...
    Client(
      stack = clientStack,
      params = clientParams).newClient(dest, label)
  }
