...
private[netty] object NettyFramedServerChannelInitializer {
 ...
 */
private[netty] class NettyFramedServerChannelInitializer(params: Stack.Params)
    extends ChannelInitializer[Channel] {

  import NettyFramedServerChannelInitializer._
